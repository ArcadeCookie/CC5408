...
onready var button_var = $Viewport/GUI/Panel/Button
...
func _ready():
	...
	#button_var = $Viewport/GUI/Panel/Button
	button_var.connect("pressed", self, "_on_Button_pressed")
	
func _on_Button_pressed():
	GUI_thing = $"."
	#GUI_thing = $".../Player/Camera/GUIPanel3D"
	button_var.disconnect("pressed", self, "_on_Button_pressed")
	GUI_thing.hide()
